...
func TestFormatTime(t *testing.T) {
	// Test with zero time
	// Note: formatTime is now internal to github package, this test would need to be moved there
	// or the function made public if needed for testing
	t.Skip("formatTime is now internal to github package")
}
